 ...
 */
public class SceneButtonAdapter extends BaseAdapter {
    ...
    public SceneButtonAdapter(Context context, List<SceneInfo> sceneInfos, SceneButtonAdapterListener listener) {
